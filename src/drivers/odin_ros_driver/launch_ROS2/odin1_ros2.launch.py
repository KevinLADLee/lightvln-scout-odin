...
def get_odin_runtime_dir():
    # Must stay in sync with GetOdinRuntimeDir() in odin_calib_path.h.
    custom = os.environ.get('ODIN_RUNTIME_DIR')
    if custom:
        return custom
...
def get_odin_calib_dir():
    # Must stay in sync with GetOdinCalibDir() in odin_calib_path.h.
    return os.environ.get('ODIN_CALIB_DIR') or get_odin_runtime_dir()
...
def generate_launch_description():
    ...
    calib_file_path = os.path.join(get_odin_calib_dir(), 'calib.yaml')
